...
public class AboutFragment extends Fragment {
    ...
    private void prepareData()
    {
        ...
        atsNr4.add("Norint nustatyti automobilį naudojamu galima rinktis vieną iš dviejų kelių:\n\n1. Atverti sekciją pavadinimu AUTOMOBILIAI, paspausti ir palaikyti ant norimo automobilio valstybinio numerio ir spustelti NUSTATYTI KAIP NAUDOJAMĄ.\n\n2. Atverti sekciją pavadinimu PAGRINDINIS ir pasirinkti norimą automobilį, išskleidus jų sąrašą.");
        atsNr5.add("Norint pamatyti realią gatvės vietą žemėlapių programėlėje, tereikia atverti sekciją pavadinimu STOVĖJIMO ZONOS, paspausti ir palaikyti ant norimos gatvės pavadinimo ir pasirinkti žemėlapių programėlę, kurią norima naudoti (Pasirinkti galima tik tada, kai telefone yra įdiegta daugiau nei viena žemėlapių programėlė).");
        atsNr6.add("Norint pašalinti automobilių valstybinius numerius, galima rinktis vieną iš dviejų kelių:\n\n1. Atverti sekciją pavadinimu AUTOMOBILIAI, paspausti ir palaikyti ant pasirinkto automobilio ir spustelti PAŠALINTI.\n\n2. Atverti sekciją pavadinimu AUTOMOBILIAI, paspausti mygtuką PAŠALINTI ir pažymėti automobilių valstybinius numerius, kuriuos norima pašalinti. ");
        atsNr7.add("Norint sužinoti stovėjimo zonos nemokamą stovėjimo laiką, tereikia atverti sekciją pavadinimu STOVĖJIMO ZONOS - šalia kiekvienos stovėjimo zonos galima matyti savaitės dienas ir laiką, kada stovėjimas yra mokamas.");
        atsNr8.add("Reguliuoti pranešimus galima sekcijoje pavadinimu NUSTATYMAI, pranešimams yra skirti du jungikliai, vienas (pirmasis) išjungia visus pranešimus apie artėjančią stovėjimo pabaigą, o kitas (antrasis) yra skirtas įjungti/išjungti SMS pranešimus arba pranešimus, ateinančius iš pačios programėlės (push notifications). SMS ir programėlės pranešimai vienu metu įjungti būti negali, jeigu įjungtas vienas, kitas išsijungia, ir atvirkščiai.");
